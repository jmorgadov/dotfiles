...
--- Wallpapers
theme.wallpaper = gears.surface.load_uncached("/home/morgado/pictures/wallpaper.jpg")
...
--- Image Assets
theme.pfp = gears.surface.load_uncached(gfs.get_configuration_dir() .. "theme/assets/mypic.jpeg")
...
theme.mstab_border_radius = dpi(15)
