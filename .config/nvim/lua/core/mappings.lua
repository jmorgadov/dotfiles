...
M.general = {
  ...
  n = {
    ...
    ["<leader>gg"] = { float_term_cmd .. "lazygit<CR>", "Open lazygit" },
    ["<leader>p"] = { float_term_cmd .. "ranger<CR>", "Open lazygit" },
    ["<leader>d"] = { float_term_cmd .. "lazydocker<CR>", "Open lazygit" }
  },
